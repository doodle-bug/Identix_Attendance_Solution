...
class Face_Recognition_system:
    ...
    def __init__(self,root):
        ...
        b1=Button(bg_img,image=self.photoimage6,command=self.attendance_data,cursor='hand2')
        b1.place(x=800,y=100,width=220,height=220)

        b1_1=Button(bg_img,text="Attendance",command=self.attendance_data,cursor='hand2',font=("times new roman",15,"bold"),bg="dark blue",fg="red")
        ...
        b1=Button(bg_img,image=self.photoimage7,command=self.help_data,cursor='hand2')
        b1.place(x=1100,y=100,width=220,height=220)

        b1_1=Button(bg_img,text="Help Desk",command=self.help_data,cursor='hand2',font=("times new roman",15,"bold"),bg="dark blue",fg="red")
        ...
        b1=Button(bg_img,image=self.photoimage10,command=self.developer_data,cursor='hand2')
        b1.place(x=800,y=380,width=220,height=220)

        b1_1=Button(bg_img,text="Developer",command=self.developer_data,cursor='hand2',font=("times new roman",15,"bold"),bg="dark blue",fg="red")
        ...
        b1=Button(bg_img,image=self.photoimage11,command=self.iExit,cursor='hand2')
        b1.place(x=1100,y=380,width=220,height=220)

        b1_1=Button(bg_img,text="Exit",command=self.iExit,cursor='hand2',font=("times new roman",15,"bold"),bg="dark blue",fg="red")
